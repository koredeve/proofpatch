...
module.exports = { normalizeUrl, missionCreate, submissionCreate, challengeCreate, evidenceItem, badRequest, assessClaimQuality, SOURCE_TYPES, CATEGORIES };

// URL normalization for dedup: strips tracking params, fragments, default ports,
// trailing slash, and case so `?utm=…` evasion fails.
